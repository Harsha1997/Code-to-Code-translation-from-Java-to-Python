...
def get_filenames(data_root, task, sub_task, split=''):
    if task == 'concode':
        ...
        if sub_task == 'cs-java':
            ...
            train_fn = '{}/train-java.java,{}/train-python.python'.format(data_dir, data_dir)
            dev_fn = '{}/valid-java.java,{}/valid-python.python'.format(data_dir, data_dir)
            test_fn = '{}/test-java.java,{}/test-python.python'.format(data_dir, data_dir)
    elif task == 'clone':
        data_dir = '{}/{}'.format(data_root, task)
